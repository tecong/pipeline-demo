...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "demoapp@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "demoapp API";

        private String description = "demoapp API documentation";
